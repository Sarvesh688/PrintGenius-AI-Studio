              ...
              <TableRow key={order._id}>
                <TableCell className="flex items-center gap-3">
                  <div className="border rounded-sm pt-2 px-2">
                    <img
                      ...
                      alt={order.listingId?.title || "Product"}
                      className="w-10 h-10 object-cover rounded"
                    />
                  </div>
                  <div>
                    <h5 className="font-medium">{order.listingId?.title || "Unknown Product"}</h5>
                    <p className="text-xs text-muted-foreground">{order.colorId?.name || "No color"}</p>
                  </div>
                </TableCell>
                <TableCell>
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 rounded-full border" style={{ backgroundColor: order.colorId?.color || "#ccc" }} />
                    <p>{order.colorId?.name || "No color"}</p>
                  </div>
                </TableCell>
